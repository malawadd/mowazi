# Moeazi Demo Capture Routes

Source: http://127.0.0.1:3100/demo/overview
...
| `extracted/tokens.json` | Design tokens: 19 colors, 5 fonts, 15 headings, 1 CTAs |
...
- **Colors**: #111111, #FFFDF5, #FFF1CF, #FFD23F, #74B9FF, #88D498, #EEF7FF, #FFF8E9, #3F3F46, #FFA552
- **Fonts**: Syne (400,500,600,700,800), Plus Jakarta Sans (400,500,600,700,800), IBM Plex Mono (400,500,600,700), __nextjs-Geist (400-600 variable), __nextjs-Geist Mono (400-600 variable)
